...
public class ContentManager extends Thread {
    ...
    private final Queue< ContentRequest< ? >> requestQueue = new LinkedList< ContentRequest< ? >>();
    private final Map< ContentRequest< ? >, Boolean > mapRequestToCacheUsageFlag = new HashMap< ContentRequest< ? >, Boolean >();

    private final Object lockQueue = new Object();
    private final Object lockAcquireService = new Object();
