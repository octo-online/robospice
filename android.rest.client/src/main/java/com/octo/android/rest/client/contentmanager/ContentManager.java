...
public class ContentManager {
	...
	@Inject
	public ContentManager(Application context) {
		mContext = context;
	...
	protected void handleServiceResult(int resultCode, Bundle resultBundle) {
		...
		synchronized (mRequestList) {
			...
			if (!mRequestList.isEmpty() && resultCode == ContentService.RESULT_OK) {
	...
	public int requestContentWithService(RestRequest<?, ?> restRequest) {
		...
		*/
		...
		optionalBundle.putBoolean(ContentService.BUNDLE_EXTRA_CACHE_ENABLED, restRequest.isUseCache());
		...
		Intent intent = new Intent(mContext, ContentService.class );
...
//	}
	...
	/**
	 * Add a {@link ContentRequestFinishedListener} to this {@link ContentManager}. Clients may use it in order to listen to events fired when a request is finished.
	 * <p>
	...
	/**
	 * Remove a {@link OnRequestFinishedListener} to this {@link ContentManager}.
	 * 
	 * @param request
