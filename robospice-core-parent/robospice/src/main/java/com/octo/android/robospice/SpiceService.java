...
public abstract class SpiceService extends Service
{
    ...
    public void onCreate()
    {
        ...
        requestProcessor = createRequestProcessor(executorService, networkStateChecker, requestProcessorListener,
                cacheManager, progressReporter, spiceServiceListenerNotifier);
     ...
     *
     *
     * @param executorService     a service executor that can be used to multi-thread request
     *                            processing.
     * @param networkStateChecker an entity that will check network state.
     * @param requestProcessorListener
     * @param progressReporter
     * @param spiceServiceListenerNotifier
     * @return a {@link RequestProcessor} that will be used to process requests.
     */
    protected RequestProcessor createRequestProcessor(ExecutorService executorService, NetworkStateChecker networkStateChecker, RequestProcessorListener requestProcessorListener, CacheManager cacheManager, RequestListenerNotifier progressReporter, SpiceServiceListenerNotifier spiceServiceListenerNotifier)
    {
        return RequestProcessor.createDefault(getApplicationContext(), cacheManager, executorService, requestProcessorListener, networkStateChecker, progressReporter, spiceServiceListenerNotifier);
    }
